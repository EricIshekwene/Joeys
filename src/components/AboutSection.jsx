...
export default function AboutSection() {
    ...
    return (
        <section className="w-full flex justify-start items-center bg-gray-100 flex justify-center mb-20 items-center gap-10">
            <div className="relative  w-full max-w-xl">
                <AboutCarousel slides={aboutSlides} interval={5000} />

                {/* Overlay in top-left */}
                <div className={`absolute top-0 left-0 z-10 ${isLarge ? 'block' : 'hidden'}`}>
                    <CircularText
            ...
            <div className="w-full ml-20 h-96 mr-20 justify-center items-end flex flex-col">

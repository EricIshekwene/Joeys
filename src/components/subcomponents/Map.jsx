...
export default function Map() {
  return (
    <div className="flex justify-center items-center rounded-lg overflow-hidden shadow-lg w-70 h-48 lg:w-160 lg:h-120 mx-auto m-6 hover:scale-105 transition-transform duration-300 ease-in-out">
      <iframe
